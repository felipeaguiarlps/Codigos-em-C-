/* Teste em C++ feito por Felipe Aguiar para aprender sobre logica e estruturas de repetição, este exercício visa calcular o salário líquido de cada funcionário, já com alíquota 
do imposto de renda referente ao seu sálario, com if aninhado e funções.
*/
